...
namespace RedBlackTree
{
    ...
    {
        private RedBlackTreeNode<TKey, TValue> _leaf = RedBlackTreeNode<TKey, TValue>.CreateLeaf();
    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            {
                rbt.Add(random.Next(0, 10000000), random.Next(0, 1000));
            }
            rbt.Add(10000001, random.Next(0, 1000));
            var watch = System.Diagnostics.Stopwatch.StartNew();
            rbt.Get(10000001);
            watch.Stop();
            var elapsedNs = watch.Elapsed.TotalMilliseconds;
            Console.WriteLine(elapsedNs);
        }
    }
}
